...
const EventCard = ({ eventId }: { eventId: Id<"events"> }) => {
  ...
  const userTicket = useQuery(
    ...
    user ? { eventId, userId: user._id } : "skip",
  );
  ...
  return (
    <Card
      ...
      className={`rounded-lg pt-0 cursor-pointer overflow-hidden hover:scale-[1.03] transition duration-200 relative ${isPastEvent ? "opacity-75 hover:opacity-100" : ""}`}
    >
      {/* Event Image */}
          ...
          <div className="flex items-start justify-between">
            ...
            <div>
              ...
              <div className="flex flex-row gap-2 mt-2">
                ...
                {isPastEvent && <Badge>Past Event</Badge>}
              </div>
            </div>
            {/* Price Tag */}
