...
const ReleaseTicket = ({ eventId, waitingListId }: { eventId: Id<"events">; waitingListId: Id<"waitingList"> }) => {
    ...
    return (
        <button
            ...
            className="mt-2 w-full flex items-center justify-center gap-2 py-2 px-4 bg-transparent text-white/80 hover:underline hover:bg-white transition disabled:opacity-50 disabled:cursor-not-allowed"
        >
